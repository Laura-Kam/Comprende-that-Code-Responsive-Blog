...
heroSection.innerHTML = `
  <div class="hero__text-container">
    ...
    <p class="hero__blog-excerpt">${mainPost[0].excerpt}<a class="hero__link" href="article.html?id=${mainPost[0].id}">Read more</a></span></p>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  blogPosts.forEach((post) => {
    ...
    article.innerHTML = `
        ...
        <p class="card__excerpt">${post.excerpt}<span><a class="read-more__link" href="article.html?id=${post.id}">Read more</a></span></p>
        </article>
      `;
